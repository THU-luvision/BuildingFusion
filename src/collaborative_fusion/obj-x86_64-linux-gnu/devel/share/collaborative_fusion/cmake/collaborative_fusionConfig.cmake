...
if("TRUE" STREQUAL "TRUE")
  set(collaborative_fusion_SOURCE_PREFIX /media/zheng/Repository/CollaborativeFusion/src/collaborative_fusion)
  set(collaborative_fusion_DEVEL_PREFIX /media/zheng/Repository/CollaborativeFusion/src/collaborative_fusion/obj-x86_64-linux-gnu/devel)
  ...
  set(collaborative_fusion_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "/media/zheng/Repository/CollaborativeFusion/src/collaborative_fusion/obj-x86_64-linux-gnu/devel/include " STREQUAL " ")
  set(collaborative_fusion_INCLUDE_DIRS "")
  set(_include_dirs "/media/zheng/Repository/CollaborativeFusion/src/collaborative_fusion/obj-x86_64-linux-gnu/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'collaborative_fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/zheng/Repository/CollaborativeFusion/src/collaborative_fusion/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT collaborative_fusion_NUM_DUMMY_TARGETS)
      set(collaborative_fusion_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::collaborative_fusion::wrapped-linker-option${collaborative_fusion_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR collaborative_fusion_NUM_DUMMY_TARGETS "${collaborative_fusion_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::collaborative_fusion::wrapped-linker-option${collaborative_fusion_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND collaborative_fusion_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/zheng/Repository/CollaborativeFusion/src/collaborative_fusion/obj-x86_64-linux-gnu/devel/lib;/opt/ros/kinetic/lib)
