...
find_path(CHISEL_INCLUDE_DIR open_chisel/Chisel.h
          PATHS
            ${CMAKE_CURRENT_SOURCE_DIR}/src/CHISEL/src/
          PATH_SUFFIXES CHISEL
)
message(${CHISEL_INCLUDE_DIR})

find_library(CHISEL_LIBRARY
             NAMES libchisel.so
             PATHS
               ${CMAKE_CURRENT_SOURCE_DIR}/src/CHISEL/build
               ${CMAKE_CURRENT_SOURCE_DIR}/src/CHISEL/src/build
