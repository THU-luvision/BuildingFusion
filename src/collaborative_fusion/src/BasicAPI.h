...
#include "./Tools/OpenNI2Interface.h"
#include <vector>
...
void  savePLYFrame(std::string fileName, Frame &f, const MultiViewGeometry::CameraPara &para);
void saveRefinedFrame(std::string fileName,  Frame &frame_new, const  MultiViewGeometry::CameraPara &para);
...
void initOfflineData(string work_folder, string associate, vector <string> &rgb_files, vector<string > &depth_files, vector<double> &time_stamp,
...
Eigen::MatrixXd &ground_truth, MultiViewGeometry::CameraPara &camera, std::vector<float> &calib_para);
...
void initCamera(MultiViewGeometry::CameraPara &camera,std::string = "");
